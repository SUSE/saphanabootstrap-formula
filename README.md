[![Formula CI](https://github.com/SUSE/saphanabootstrap-formula/actions/workflows/formulaCI.yml/badge.svg)](https://github.com/SUSE/saphanabootstrap-formula/actions/workflows/formulaCI.yml)
